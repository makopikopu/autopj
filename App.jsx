...
export default function App() {
  ...
  const [keyDraft, setKeyDraft] = useState({ etherscan: "", helius: "", meganode: "" });
    ...
    (async () => {
      ...
      try {
        ...
        if (k && k.value) {
          ...
          setKeyDraft({ etherscan: parsed.etherscan || "", helius: parsed.helius || "", meganode: parsed.meganode || "" });
        }
      } catch (e) {}
      try {
      ...
      {showKeys && (
        <div style={styles.card}>
          ...
          <div style={styles.note}>
            ...
            代わりに<strong>MegaNode(BSCTrace)APIキー</strong>(無料枠あり)を使います。どれもブラウザに保存されるだけで、サーバーには送信されません。
