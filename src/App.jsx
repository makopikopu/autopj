...
export default function App() {
  ...
  const SOL_TOKEN_PROGRAMS = [
    ...
    "TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnwqL9nKZBHDp2", // Token-2022
  ];
          ...
          try {
            ...
            if (mints.length > 0) {
              ...
              for (const mint of mints) {
                const symbol = solTokenSymbolCache[mint] || mint.slice(0, 4);
                next[`sol|${addr}|${symbol}`] = (next[`sol|${addr}|${symbol}`] || 0) + qtyByMint[mint];
              }
            }
          } catch (e) {
